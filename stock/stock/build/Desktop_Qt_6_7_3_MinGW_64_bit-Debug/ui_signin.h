...
{
public:
    QWidget *centralwidget_stock;
    QStackedWidget *stackedWidget_stock;
    QWidget *pageSignIn;
    QLabel *title;
    ...
    QPushButton *Editspecies_stock;
    QGroupBox *formstic_stock;
...
"    min-width: 280px;\n"
"}"));
        centralwidget_stock = new QWidget(SignIn);
        centralwidget_stock->setObjectName("centralwidget_stock");
        stackedWidget_stock = new QStackedWidget(centralwidget_stock);
        stackedWidget_stock->setObjectName("stackedWidget_stock");
        stackedWidget_stock->setGeometry(QRect(0, 0, 1021, 741));
        stackedWidget_stock->setStyleSheet(QString::fromUtf8(""));
...
"}"));
        ...
        stackedWidget_stock->addWidget(pageSignIn);
...
""));
        ...
        stackedWidget_stock->addWidget(pageForgetpass);
...
"}\n"
"\n"
"QCommandLinkButton#userprofiledetails_stock:pressed {\n"
...
"\n"
"/* Hover effect */\n"
"QPushButton#clientsmanagem"
                        "entBTN_stock:hover,\n"
"QPushButton#equipmentmanagementBTN_stock:hover,\n"
...
"/* All labels inside"
                        " the form */\n"
"QFrame#formAddStaff QLabel_stock {\n"
...
""
                        "}\n"
"\n"
"QPushButton#addstaffbtn_stock:hover {\n"
...
""));
        ...
        horizontalLayout_2->addWidget(sidebarMenu_stock);
        ...
        header_stock = new QFrame(verticalLayoutWidget);
        ...
        verticalLayout_2->addWidget(header_stock);
        ...
        listfish = new QFrame(layoutWidget2);
        ...
        table_stock->setGeometry(QRect(10, 150, 411, 301));
        ...
        Editspecies_stock = new QPushButton(liststock);
        Editspecies_stock->setObjectName("Editspecies_stock");
        Editspecies_stock->setGeometry(QRect(220, 490, 161, 41));
        formstic_stock = new QGroupBox(listfish);
        formstic_stock->setObjectName("formstic_stock");
        formstic_stock->setGeometry(QRect(440, 0, 401, 601));
        formAddSpecies = new QFrame(formstic_stock);
        ...
        stackedWidget_stock->setCurrentIndex(2);
    ...
    void retranslateUi(QMainWindow *SignIn)
    {
        ...
        ___qtablewidgetitem->setText(QCoreApplication::translate("SignIn", "Species", nullptr));
        ...
        ___qtablewidgetitem2->setText(QCoreApplication::translate("SignIn", "Zone", nullptr));
        deletespecies_stock->setText(QCoreApplication::translate("SignIn", "Delete Species", nullptr));
        Editspecies_stock->setText(QCoreApplication::translate("SignIn", "Edit Species", nullptr));
        formstic_stock->setTitle(QString());
