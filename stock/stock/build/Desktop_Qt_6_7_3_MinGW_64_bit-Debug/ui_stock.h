...
"/* All labels inside "
                        "the form */\n"
"QFrame#formAddSpecies QLabel_stock {\n"
...
"\n"
"#table_stock {\n"
"    background-color: rgba(10, 25, 40,"
                        " 0.95);\n"
...
"}\n"
""));
        layoutWidget = new QWidget(pageFishStock);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(0, 0, 1491, 761));
        horizontalLayout_2 = new QHBoxLayout(layoutWidget);
        horizontalLayout_2->setObjectName("horizontalLayout_2");
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        sidebarMenu_stock = new QFrame(layoutWidget);
        ...
        contenumain = new QFrame(layoutWidget);
        ...
        layoutWidget1 = new QWidget(contenumain);
        layoutWidget1->setObjectName("layoutWidget1");
        layoutWidget1->setGeometry(QRect(-10, 100, 831, 621));
        horizontalLayout_3 = new QHBoxLayout(layoutWidget1);
        horizontalLayout_3->setObjectName("horizontalLayout_3");
        horizontalLayout_3->setContentsMargins(0, 0, 0, 0);
        listfish = new QFrame(layoutWidget1);
